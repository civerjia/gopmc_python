...
#define PPETHRESHOLD 1.0 // energy threshold of proton proton interaction
#define POETHRESHOLD 1.0 // energy threshold of proton oxygen elastic interaction
#define POITHRESHOLD 1.0 // energy threshold of proton oxygen inelastic interaction
